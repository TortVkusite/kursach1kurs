...
void menu()
{
	...
	SDL_Texture* nextlvl_tex = loadtexturefromfile("hero\\1331474.png", &hero_rect);
	...
	SDL_Rect next_lvl = { wig - 150,  50, 100, 50 };
		int x = 0, y = 0;
		while (SDL_PollEvent(&ev))
		{
			switch (ev.type)
		...
		if (tap_on_but(x, y, wig-150,  50, 100, 80))
		{
			runing = false;
			break;
		}
...
void init()
{
	...
	win = SDL_CreateWindow("mY COOL window", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
...
{
	SDL_SetRenderDrawColor(ren, 20, 200, 20, 255);
	SDL_RenderClear(ren);
	...
	int a = 100;
	struct tach mas[] =
	{ {win_width / 2 - a,win_height / 2},{win_width / 2 - a / 2 ,win_height / 2 + a * 3 / 4},{win_width / 2 + a / 2 ,win_height / 2 + a * 3 / 4},
		{win_width / 2 + a ,win_height / 2},{win_width / 2 + a / 2 ,win_height / 2 - a * 3 / 4},{win_width / 2 - a / 2 ,win_height / 2 - a * 3 / 4},{win_width / 2 - a,win_height / 2},{win_width / 2 - a / 2 ,win_height / 2 + a * 3 / 4},{win_width / 2 + a / 2 ,win_height / 2 + a * 3 / 4},
		{win_width / 2 + a ,win_height / 2},{win_width / 2 + a / 2 ,win_height / 2 - a * 3 / 4},{win_width / 2 - a / 2 ,win_height / 2 - a * 3 / 4} };


	for (int i = 0; i < 6; i++)
		for (int j = i; j < 6; j++)
			SDL_RenderDrawLine(ren, mas[i].x, mas[i].y, mas[j].x, mas[j].y);
	a = 20;
	SDL_RenderDrawLine(ren, mas[2].x, mas[2].y, mas[2].x, mas[2].y + a);
	SDL_RenderDrawLine(ren, mas[2].x, mas[2].y, mas[2].x + a * 2 / 3, mas[2].y + a);


	SDL_RenderDrawLine(ren, mas[3].x, mas[3].y, mas[3].x + a, mas[3].y - a * 2 / 3);
	SDL_RenderDrawLine(ren, mas[3].x, mas[3].y, mas[3].x + a, mas[3].y + a * 2 / 3);

	SDL_RenderDrawLine(ren, mas[4].x, mas[4].y, mas[4].x, mas[4].y - a);
	SDL_RenderDrawLine(ren, mas[4].x, mas[4].y, mas[4].x + a * 2 / 3, mas[4].y - a);

	SDL_RenderDrawLine(ren, mas[5].x, mas[5].y, mas[5].x, mas[5].y - a);
	SDL_RenderDrawLine(ren, mas[5].x, mas[5].y, mas[5].x - a * 2 / 3, mas[5].y - a);

	SDL_RenderDrawLine(ren, mas[6].x, mas[6].y, mas[6].x - a, mas[6].y - a * 2 / 3);
	SDL_RenderDrawLine(ren, mas[6].x, mas[6].y, mas[6].x - a, mas[6].y + a * 2 / 3);


	SDL_RenderDrawLine(ren, mas[7].x, mas[7].y, mas[7].x, mas[7].y + a);
	SDL_RenderDrawLine(ren, mas[7].x, mas[7].y, mas[7].x - a * 2 / 3, mas[7].y + a);
